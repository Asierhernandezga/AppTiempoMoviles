...
public class GipuzkoaConsultas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gipuzkoa_consultas);
        ...
        try {
            ...
            String query = "select Name from pueblos where ID_Provincia = "  + "\'" + idProvinciaGipuzkoa + "\'";
